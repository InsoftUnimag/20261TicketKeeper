...
public record GetTicketStatusResponse(
        ...
        @Schema(description = "ID del evento asociado al ticket", example = "00016ec5-90fb-4c63-aba9-3ea17abd27c0") String eventId,
        @Schema(description = "Nombre del evento", example = "Clase Diseño Organizacional") String eventName,
        @Schema(description = "Nombre del recinto", example = "Edificio Principal") String recintoName,
        @Schema(description = "Nombre de la zona", example = "Delantera") String zoneName,
